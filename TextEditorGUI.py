...
PROGRAM_NAME = "Rahul's Text Editor"
file_name = None
...
def exit_editor(event=None):
    if tkinter.messagebox.askokcancel("Exit?", "oops!\nI see that you didn't save your work.\nDo you still want to exit?"):
        root.destroy()
...
def write_to_file(file_name):
    try:
        ...
        tkinter.messagebox.showwarning("Error While Saving", "Could not save the file.")
